...
def Koleksipribadi_list(request):
    books = Koleksipribadi.objects.all()
    return render(request, 'list_Koleksipribadi/Admin.html', {'books': books})

def Peminjam_Koleksipribadi_list(request):
    books = Koleksipribadi.objects.all()
    return render(request, 'list_Koleksipribadi/Peminjam.html', {'books': books})
