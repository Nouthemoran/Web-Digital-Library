...
def Kategoribuku_list(request):
    ...
    return render(request, 'list_kategori/Admin_list.html', {'kategoris': kategoris})

def Peminjam_Kategoribuku_list(request):
    kategoris = Kategoribuku.objects.all()
    return render(request, 'list_kategori/Peminjam_list.html', {'kategoris': kategoris})
...
def create_Kategoribuku(request):
    ...
    return render(request, 'form_kategori/Admin_form.html', {'form': form})
